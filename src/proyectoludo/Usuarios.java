...
public class Usuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        usuarios_tbl_users.setSelectionBackground(new java.awt.Color(255, 153, 0));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(263, 58, 690, 380));
        ...
        usuarios_btn_add.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectoludo/add1.png"))); // NOI18N
        usuarios_btn_add.setText("Añadir");
        usuarios_btn_add.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        usuarios_btn_edit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectoludo/edit1.png"))); // NOI18N
        usuarios_btn_edit.setText("Editar");
        usuarios_btn_edit.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        principal_btn_clean.setFont(new java.awt.Font("Tahoma", 1, 10)); // NOI18N
        principal_btn_clean.setForeground(new java.awt.Color(51, 51, 51));
        principal_btn_clean.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectoludo/clear1.png"))); // NOI18N
        principal_btn_clean.setText("Limpiar");
        principal_btn_clean.setToolTipText("Limpiar los campos");
        principal_btn_clean.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        usuarios_btn_del.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectoludo/delete1.png"))); // NOI18N
        usuarios_btn_del.setText("Eliminar");
        usuarios_btn_del.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(usuarios_btn_del, javax.swing.GroupLayout.DEFAULT_SIZE, 91, Short.MAX_VALUE)
                    .addComponent(usuarios_btn_edit, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(usuarios_btn_add, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(principal_btn_clean, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, 220, 140));

        usuarios_jtf_nombre.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        usuarios_jtf_nombre.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        usuarios_jtf_pass.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        usuarios_jtf_email.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        usuarios_cb_rank.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        usuarios_jtf_tlf.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        ...
        usuarios_jtf_id.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true));
        usuarios_jtf_id.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        usuarios_jtf_id.setEnabled(false);
        getContentPane().add(usuarios_jtf_id, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 60, -1));
        ...
        usuarios_btn_orderAccept.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        usuarios_btn_orderAccept.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                usuarios_btn_orderAcceptActionPerformed(evt);
            }
        });
        getContentPane().add(usuarios_btn_orderAccept, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 30, 50, 20));
